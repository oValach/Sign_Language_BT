...
plt.legend(['Hammingova','Eukleidovská','Minkowskeho','Mahalanobisova','Čebyševova'], bbox_to_anchor=(-0.02,1.02,1.04,0.2), loc="lower left", mode="expand", borderaxespad=0, ncol=5)
plt.show()